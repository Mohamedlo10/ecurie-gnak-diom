...
import ChatBotInfo from "./chatbot/chatbot";
  ...
  return (
    <div className="flex flex-col w-full flex-auto min-w-0">
      ...
      <div className=" w-full">
        ...
        <div className="flex flex-row w-full  rounded-xl  items-center justify-center max-w-screen-xl mx-auto px-6 sm:px-8 text-base lg:text-xl font-semibold  tracking-tight leading-7 md:leading-snug truncate">
          {/* Avatar and name */}
      ...
      <div className="flex-auto bg-white -mt-px">
        <div className="w-full max-w-screen-xl mx-auto">
          {/* Tabs */}
          <div className="tabs flex flex-row gap-28 p-2 pt-4 items-end justify-center">
            <Button
          ...
          <div className="tab-content">
            ...
            {activeTab === 3 && (
              <div>
                {" "}
                <ChatBotInfo sujetId={sujet?.idsujet} />{" "}
              </div>
            )}
          </div>
        </div>
