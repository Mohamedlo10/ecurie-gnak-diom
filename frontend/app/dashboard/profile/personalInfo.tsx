        ...
        <div>
          ...
          <div className="grid grid-cols-2 gap-12">
            ...
            <div className="mb-4">
                ...
                <div className="leading-6 mt-1 text-sm sm:text-base font-bold">{compte?.prenom}</div>
              </div>
              <div className="mb-4">
                <div className="text-gray-500 text-sm sm:text-base">Mail</div>
              ...
              <div className="mb-4">
                ...
                <div className="leading-6 mt-1 text-sm sm:text-base font-bold">{compte?.role}</div>
              </div>
            ...
            <div className="mb-4">
                ...
                <div className="leading-6 mt-1 text-sm sm:text-base font-bold">{compte?.nom}</div>
              </div>
