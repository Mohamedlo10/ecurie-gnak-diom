  ...
  return (
    <div>
      <div className="p-2 rounded-md w-full  items-start px-7 justify-start flex flex-col gap-1">
        <div className="flex flex-col w-full overflow-y-auto px-20 max-h-[62vh]">
              ...
              <div className="container w-full mx-auto p-3">
                ...
                >
                  <div className="flex flex-row w-full ">
                    <div
                      className={` ${
                        user.role != "professeur" ? " w-full " : "w-full"
                      }`}
                    >
                      ...
                      <div className="flex flex-row mb-6  gap-4 mt-4 rounded-lg">
                        <div className="">
                          <div className="text-gray-500 text-sm ">
                            Date limite de soumission
                          </div>
                          <div className="leading-6 text-sm  font-bold">
                            {" "}
                            {new Date(
                  ...
                  <div className="w-full items-start  rounded-xl  justify-start flex flex-col gap-1">
                    {!file && !copie && user.role != "professeur" && (
                      <>
                        <label
                          htmlFor="file"
                          className="cursor-pointer w-full h-64 flex-col rounded-xl flex items-center justify-center bg-gray-200 hover:bg-gray-300 border-b"
                        >
                          <img
                            src="/upload.png"
