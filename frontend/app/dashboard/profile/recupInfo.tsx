...
const RecupInfo = () => {
	...
	return (
		<div className="flex h-[80vh] overflow-y-auto flex-col flex-auto min-w-0">
			{/* Header */}
			<div className="p-4">
				<div className="flex flex-col w-full max-w-screen-xl mx-auto px-6 sm:px-8">
					<div className="flex flex-col sm:flex-row flex-auto sm:items-center min-w-0 my-4">
						...
						<div className="flex flex-auto items-center min-w-32 gap-12">
							<div className="relative w-28 h-28 sm:w-28 sm:h-28 rounded-full border-4 bg-slate-100 flex items-center justify-center">
								{!imageLoaded &&
									(user?.email ? (
