...
const ConfirmDialog: React.FC<ConfirmDeleteDialogProps> = ({ onConfirm, onCancel, isOpen, message }) => {
  return (
    <AlertDialog open={isOpen} onOpenChange={(open) => !open && onCancel()}>
        <AlertDialogTitle className='text-white hidden'>
            ELITE
        </AlertDialogTitle>
      <AlertDialogContent>
        <div className='font-bold h-10 items-center justify-start flex -p-8 w-full text-white border-b '>Confirmation</div>
